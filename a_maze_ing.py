...
def generate_and_render(config, pal_idx, animate=True):
    ...
    theme = {"walls": pal["walls"], "inner": pal["inner"], "pattern": pal["pattern"]}
...
def main() -> None:
    ...
    try:
        ...
        while True:
            ...
            print(f"{BLUE} ▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄{RESET}")
            print(f"{BLUE} ▌            ▌            ▌           ▌            ▌           ▌{RESET}")
            print(f"{BLUE} ▌{RESET} [R]{RED} Regen{RESET}  {BLUE}▌{RESET} [S]{RED} Solve{RESET}  {BLUE}▌{RESET} [P]{RED} Play{RESET}  {BLUE}▌{RESET} [C]{RED} Theme{RESET}  {BLUE}▌{RESET} [Q]{RED} Quit{RESET}  {BLUE}▌{RESET}")
            print(f"{BLUE} ▌            ▌            ▌           ▌            ▌           ▌{RESET}")
            print(f"{BLUE} ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀{RESET}")
            ...
            if choice == "q":
                ...
                if path_cells:
                    path_cells = None
                    clear_screen()
                    render_ascii(grid, config.entry, config.exit, theme, show_42=True)
                    continue
